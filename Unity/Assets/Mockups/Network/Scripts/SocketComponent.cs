...
public class SocketComponent : MonoBehaviour
{
    ...
    private void ListenEvents(CancellationToken token)
    {
        ...
        IPAddress ipdAddress = ipHostEntry.AddressList.FirstOrDefault(ip => ip.AddressFamily == AddressFamily.InterNetwork);
        IPEndPoint ipEndPoint = new IPEndPoint(ipdAddress, PORT);
        listener = new Socket(ipdAddress.AddressFamily, SocketType.Stream, ProtocolType.Tcp);
        ...
        try
        {
            ...
            while(!token.IsCancellationRequested)
            {
                ...
                Debug.Log("Waiting connection to host " + ipdAddress.MapToIPv4().ToString() + " : " + PORT);
